...
async function main() {
  ...
  console.log("\u{1F331} Seeding location_metrics for ACME Downtown (90 days)...");
  ...
  console.log("\u{1F9F9} Cleaned existing metrics");
  const DAYS = 90;
  ...
  console.log("\n\u{1F331} Seeding location_competitors...");
  await prisma.$executeRawUnsafe(
  ...
  console.log("\n\u2705 Seed complete!");
  console.log(`\u{1F4CA} Location: ${locationId}`);
  console.log(`\u{1F4C8} 90 days of daily metrics seeded (trending +30% impressions, +40% photo views)`);
  console.log(`\u{1F3C6} 3 local competitors added`);
}
main().catch((e) => {
  console.error(e);
  process.exit(1);
