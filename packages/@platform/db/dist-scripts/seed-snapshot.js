...
// ../../../node_modules/.pnpm/@prisma+debug@7.2.0/node_modules/@prisma/debug/dist/index.js
var require_dist = __commonJS({
  "../../../node_modules/.pnpm/@prisma+debug@7.2.0/node_modules/@prisma/debug/dist/index.js"(exports2, module2) {
    "use strict";
    ...
    var index_default = Debug2;
  }
});

// ../../../node_modules/.pnpm/@prisma+driver-adapter-utils@7.2.0/node_modules/@prisma/driver-adapter-utils/dist/index.js
var require_dist2 = __commonJS({
  "../../../node_modules/.pnpm/@prisma+driver-adapter-utils@7.2.0/node_modules/@prisma/driver-adapter-utils/dist/index.js"(exports2, module2) {
    "use strict";
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
...
var require_lib2 = __commonJS({
  "../../../node_modules/.pnpm/pg@8.16.3/node_modules/pg/lib/index.js"(exports2, module2) {
    ...
    var TypeOverrides = require_type_overrides();
    var { DatabaseError } = require_dist3();
...
var require_postgres_array2 = __commonJS({
  "../../../node_modules/.pnpm/postgres-array@3.0.4/node_modules/postgres-array/index.js"(exports2) {
    ...
    exports2.parse = (source, transform) => transform != null ? makeParseArrayWithTransform(transform)(source) : parseArray(source);
  }
});

// ../../../node_modules/.pnpm/@prisma+adapter-pg@7.2.0/node_modules/@prisma/adapter-pg/dist/index.js
var require_dist4 = __commonJS({
  "../../../node_modules/.pnpm/@prisma+adapter-pg@7.2.0/node_modules/@prisma/adapter-pg/dist/index.js"(exports2, module2) {
    "use strict";
    ...
    var import_pg2 = __toESM2(require_lib2());
    var name = "@prisma/adapter-pg";
    var FIRST_NORMAL_OBJECT_ID = 16384;
    var import_driver_adapter_utils = require_dist2();
    var import_pg = __toESM2(require_lib2());
    var import_postgres_array = require_postgres_array2();
...
var require_client3 = __commonJS({
  "src/client.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.prismaAdmin = exports2.prisma = void 0;
    exports2.disconnectDatabase = disconnectDatabase;
    var client_1 = require("@prisma/client");
    var adapter_pg_1 = require_dist4();
    ...
    var pool = new pg_1.Pool(getPoolConfig());
    ...
    exports2.prisma = globalForPrisma.prisma || new client_1.PrismaClient({
      adapter,
      log: getLogConfig(),
      errorFormat: process.env.NODE_ENV === "development" ? "pretty" : "minimal"
    });
    var adminConnectionString = process.env.DATABASE_ADMIN_URL || connectionString;
    var adminPool = new pg_1.Pool({ ...getPoolConfig(), connectionString: adminConnectionString });
    var adminAdapter = new adapter_pg_1.PrismaPg(adminPool);
    exports2.prismaAdmin = new client_1.PrismaClient({
      adapter: adminAdapter,
      log: getLogConfig(),
      errorFormat: process.env.NODE_ENV === "development" ? "pretty" : "minimal"
    });
    if (process.env.NODE_ENV !== "production") {
      globalForPrisma.prisma = exports2.prisma;
    }
    async function disconnectDatabase() {
      await exports2.prisma.$disconnect();
      await pool.end();
...
var prisma;
async function main() {
  const clientModule = await Promise.resolve().then(() => __toESM(require_client3()));
  prisma = clientModule.prisma;
  const dbUrl = process.env.DATABASE_URL || "";
  console.log(`\u{1F50C} Connecting to database: ${dbUrl.replace(/:[^:@]*@/, ":****@")}`);
  console.log("\u{1F331} Seeding GBP Profile Snapshot and Audit...");
  ...
  console.log("\u{1F9F9} Cleaned up old snapshots and audits");
  ...
  const snapshotData = {
    ...
    description: "Welcome to ACME Downtown \u2014 your neighborhood breakfast and brunch spot in the heart of San Francisco. We serve organic, locally-sourced food with a strong focus on quality and community. Perfect for remote workers looking for great wifi and a cozy atmosphere. Visit us today!",
    hours: {
      periods: [
    ...
    media: [
      ...
      { locationAssociation: { category: "FOOD_AND_DRINK" }, createTime: d60.toISOString(), dimensions: { widthPixels: 1e3, heightPixels: 750 } },
      ...
      warning: [
        {
          ...
          recommendation: "Replace the 640\xD7480 exterior photo with a high-resolution version (minimum 1080px wide).",
  ...
  console.log(`
\u{1F4CB} Snapshot ID for testing: ${snapshot.id}`);
  console.log(`\u{1F4CB} Location ID: ${locationId}`);
}
main().catch((e) => {
  console.error(e);
  process.exit(1);
